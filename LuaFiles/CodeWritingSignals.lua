...
function writeClassBasedOnNumberOfArguments(myFile, nargs)
	...
	output = output..tabs(3)..					'assert(!isConnected(*receiver));\n'
	output = output..tabs(3)..					'connectUnchecked(*receiver, function);\n'
	output = output..tabs(2)..				'}\n'
	output = output..tabs(1)..			'}\n'	
	output = output..tabs(1)..			'\n'
	...
	output = output..tabs(2)..			'{\n'	
	output = output..tabs(3)..				'const Receiver* pointer(&receiver);\n'
	output = output..tabs(3)..				'return connection.isReceiver(pointer);\n'
	output = output..tabs(2)..			'}\n'	
	output = output..tabs(1)..		'};\n'
	...
	output = output..tabs(3)..					'{\n'
	output = output..tabs(4)..						'bool isFound;\n'
	...
	output = output..tabs(4)..						'else\n'
	output = output..tabs(4)..						'{\n'
	output = output..tabs(5)..							'isFound = iter->isFunction(function);\n'
	output = output..tabs(4)..						'}\n'
	output = output..tabs(4)..						'\n'
	output = output..tabs(4)..						'if (isFound)\n'
	output = output..tabs(4)..						'{\n'	
	...
	output = output..tabs(6)..								'{	// ...preserve integrity of the transmission\n'
	output = output..tabs(7)..									'm_transmissionFailSafe = iter->m_next;\n'
	output = output..tabs(7)..									'm_transmissionIter = NULL;\n'
	output = output..tabs(6)..								'}\n'
	output = output..tabs(6)..								'// ...else if we removed the fail safe during a transmission...\n'
	output = output..tabs(6)..								'else if (m_transmissionFailSafe == iter)\n'
	output = output..tabs(6)..								'{	// ...preserve integrity of the transmission\n'
	output = output..tabs(7)..									'm_transmissionFailSafe = m_transmissionFailSafe->m_next;\n'
	output = output..tabs(7)..									'm_transmissionIter = NULL;\n'
	output = output..tabs(6)..								'}\n'
	output = output..tabs(5)..							'}\n'
	output = output..tabs(5)..							'\n'
	...
	output = output..tabs(1)..			'template <typename RECIEVER, typename IS_EQUAL>\n'
	output = output..tabs(1)..			'bool isConnected(RECIEVER& receiver, const IS_EQUAL& isEqual) const\n'
	output = output..tabs(1)..			'{\n'
	output = output..tabs(2)..				'SYNC(m_mutex);\n'
	output = output..tabs(2)..				'Connection* iter(m_receivers);\n'
	output = output..tabs(2)..				'\n'
