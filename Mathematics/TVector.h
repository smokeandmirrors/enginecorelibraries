...
@{
*/
typedef V2<float> Vector2TF;
typedef V3<float> Vector3TF;

extern const Vector2TF	down2D;
extern const Vector2TF	left2D;
extern const Vector2TF	origin2D;
extern const Vector2TF	right2D;
extern const Vector2TF	up2D;
extern const Vector3TF	down3D;
extern const Vector3TF	backward3D;
extern const Vector3TF	forward3D;
extern const Vector3TF	left3D;
extern const Vector3TF	origin3D;
extern const Vector3TF	right3D;
extern const Vector3TF	up3D;
...
#if EXTENDED_BY_LUA
DECLARE_LUA_LUAEXTENDABLE_NS(math, Vector2TF);
DECLARE_LUA_LUAEXTENDABLE_NS(math, Vector3TF);
#endif//EXTENDED_BY_LUA
