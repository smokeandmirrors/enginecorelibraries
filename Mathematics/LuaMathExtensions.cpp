...
namespace lua_library_Vector2 
{
	...
	static const luaL_reg Vector2_library[] = 
	{
		...
		LUA_NAMED_ENTRY("add", (memberReturn0Param1<Vector2, const Vector2&, &Vector2::add>))
...
#define DEFINE_VECTOR3_OPERATOR(name, opfunc) \
	...
	static const luaL_reg Vector3_library[] = 
	{
		...
		LUA_NAMED_ENTRY("__eq", (const_Return1Param1<Vector3, bool, const Vector3&, &V3<float>::operator==>))
		LUA_ENTRY_CLASS__isnewindexable_FALSE
		LUA_ENTRY(		 add)
		LUA_NAMED_ENTRY("construct", initialize)
		LUA_ENTRY(		 cross)
		LUA_NAMED_ENTRY("distance", (const_Return1Param1<Vector3, sreal, const Vector3&, &V3<float>::distance>))
		LUA_NAMED_ENTRY("distanceSqr", (const_Return1Param1<Vector3, sreal, const Vector3&, &V3<float>::distanceSqr>))
		LUA_NAMED_ENTRY("distanceXY", (const_Return1Param1<Vector3, sreal, const Vector3&, &V3<float>::distanceXY>))
		LUA_NAMED_ENTRY("distanceXYSqr", (const_Return1Param1<Vector3, sreal, const Vector3&, &V3<float>::distanceXYSqr>))
		LUA_ENTRY(		 divide)
		LUA_NAMED_ENTRY("dot", (const_Return1Param1<Vector3, sreal, const Vector3&, &V3<float>::dot>))
		LUA_ENTRY(		 equals)
		LUA_NAMED_ENTRY("isFar", (const_Return1Param2<Vector3, bool, const Vector3&, sreal, &V3<float>::isFar>))
		LUA_NAMED_ENTRY("isFarXY", (const_Return1Param2<Vector3, bool, const Vector3&, sreal, &V3<float>::isFarXY>))
		LUA_NAMED_ENTRY("isNear", (const_Return1Param2<Vector3, bool, const Vector3&, sreal, &V3<float>::isNear>))
		LUA_NAMED_ENTRY("isNearXY", (const_Return1Param2<Vector3, bool, const Vector3&, sreal, &V3<float>::isNearXY>))
		LUA_NAMED_ENTRY("isNormal", (const_Return1Param0<Vector3, bool, &V3<float>::isNormal>))
		LUA_NAMED_ENTRY("isZero", (const_Return1Param0<Vector3, bool, &V3<float>::isZero>))
		LUA_NAMED_ENTRY("magnitude", (const_Return1Param0<Vector3, sreal, &V3<float>::magnitude>))
		LUA_NAMED_ENTRY("magnitudeSqr", (const_Return1Param0<Vector3, sreal, &V3<float>::magnitudeSqr>))
		LUA_NAMED_ENTRY("magnitudeXY", (const_Return1Param0<Vector3, sreal, &V3<float>::magnitudeXY>))
		LUA_NAMED_ENTRY("magnitudeXYSqr", (const_Return1Param0<Vector3, sreal, &V3<float>::magnitudeXYSqr>))
		LUA_ENTRY(		 nearlyEquals)
		LUA_NAMED_ENTRY("negate", (memberReturn0Param0<Vector3, &V3<float>::negate>))
		LUA_NAMED_ENTRY("normalize", (memberReturn1Param0<Vector3, sreal, &V3<float>::normalize>))
		LUA_NAMED_ENTRY("perpendicular", (memberReturn0Param0<Vector3, &V3<float>::perpendicular>))
		LUA_ENTRY(		 scale)
		LUA_NAMED_ENTRY("set", initialize)
		// slightly higher performance options for Lua
		LUA_NAMED_ENTRY("setAll", (memberReturn0Param1<Vector3, sreal, &V3<float>::set>))
		LUA_NAMED_ENTRY("setEach", (memberReturn0Param3<Vector3, sreal, sreal, sreal, &V3<float>::set>))
		LUA_NAMED_ENTRY("setEqual", (memberReturn0Param1<Vector3, const Vector3&, &V3<float>::set>))
		LUA_NAMED_ENTRY("setIndex", (memberReturn0Param2<Vector3, uint, sreal, &V3<float>::set>))
		LUA_ENTRY(		 subtract)
		LUA_NAMED_ENTRY("zero", (memberReturn0Param0<Vector3, &V3<float>::zero>))
