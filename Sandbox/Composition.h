...
public:
	...
	virtual const designPatterns::RunTimeType& getRunTimeType(void) const=0;
...
public:
	...
	bool has(const designPatterns::RunTimeType& componentType) const
	{
...
private:
	...
	Component<COMPOSITE>* find(const designPatterns::RunTimeType& componentType) const
	{
